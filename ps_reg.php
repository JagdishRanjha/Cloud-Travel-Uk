...
<head>
  ...
  <title>Project & Services Registration</title>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><span class="box-title">Product and Services Registration</span></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><span class="box-title">Product and Services Registration</span></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Product and Services Registration</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <form class="form" id="userForm" method="post" action="core/add_service.php">
