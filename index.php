        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php 
						$sql2 = "select count(*) from client_register ";
						$result2 = mysqli_query($con,$sql2);
						$row2 = mysqli_fetch_array($result2);
						echo $row2['count(*)'];?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php 
						$new = date('d/m/Y');
						$sql4 = "select count(*) from appointment where date ='$new' ";
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Appointments</span>
                    <span class="progress-number"><b><?php 
						$new = date('d/m/Y');
						$sql4 = "select count(*) from appointment where date ='$new' ";
						$result4 = mysqli_query($con,$sql4);
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    <span class="description-percentage text-red"><i class="fa fa-caret-up"></i> 5%</span>
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    ...
                    <h5 class="description-header"><?php 
						...
						$result3 = mysqli_query($con,$sql3);
						$row3 = mysqli_fetch_array($result3);
						$amount =   35210.43 - $row3['sum(expense_amount)'];
						echo $amount;
						?></h5>
...
<!--
                  <form class="form "method="post" action="core/add_message.php">
                    <div class="input-group">
                      <input type="text" name="message" id="message" placeholder="Type Message ..." class="form-control" >
                      <span class="input-group-btn">
                            <button type="submit" id="submit" name ="submit" class="btn btn-warning btn-flat">Save</button>
                      </span>
                    </div>
                  </form>
-->
